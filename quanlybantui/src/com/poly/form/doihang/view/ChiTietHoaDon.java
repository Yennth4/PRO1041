...
public class ChiTietHoaDon extends javax.swing.JFrame {
     ...
     */
    public ChiTietHoaDon(DoiHangConfigs doiHangConfigs, Menu menu,FormQuanLyDoiHang formQuanLyDoiHang) {
        initComponents(); 
        setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
        setContentPane(new DoiHangChiTiet(doiHangConfigs, menu,formQuanLyDoiHang,this));
